	...
	<div id="gallerydiv" class="postbox <?php echo postbox_classes('gallerydiv', 'ngg-manage-gallery'); ?>" >
		...
		<div class="inside">
			<table class="form-table" >
				...
				?>
				<tr> 
					<th align="left"><input <?php if ( is_multisite() ) echo 'readonly = "readonly"'; ?> <?php nggGallery::current_user_can_form( 'NextGEN Edit gallery path' ); ?> type="hidden" size="50" name="path" value="<?php echo $gallery->path; ?>"  /></th>
				</tr>
				<?php }
				/* Agnidata */
				?>
