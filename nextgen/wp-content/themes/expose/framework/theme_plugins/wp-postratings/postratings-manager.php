			...
			foreach($postratings_logs as $postratings_log) {
				...
				if($ratings_custom && $ratings_max == 2) {
					...
					if('rtl' == $text_direction && file_exists(KFWPLUGINS_URI.'/wp-postratings/images/'.$ratings_image.'/rating_end-rtl.'.RATINGS_IMG_EXT)) {
						echo '<img src="'.template_url('wp-postratings/images/'.$ratings_image.'/rating_end-rtl.'.RATINGS_IMG_EXT).'" alt="" class="post-ratings-image" />';
					} elseif(file_exists(KFWPLUGINS_URI.'/wp-postratings/images/'.$ratings_image.'/rating_end.'.RATINGS_IMG_EXT)) {
						echo '<img src="'.template_url('wp-postratings/images/'.$ratings_image.'/rating_end.'.RATINGS_IMG_EXT).'" alt="" class="post-ratings-image" />';
					}
				}
				echo '</td>'."\n";
