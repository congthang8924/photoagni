	...
	?>
	           ...
	           <?php the_content(); ?>
	 			...
	 			<form action="" method="post" class="ajax_form">
						...
						<p><input name="website" class="text_input is_empty" type="text" id="website" size="20" value="<?php if (isset($the_website))  echo $the_website?>"/><label for="website"><?php _e('Website you want to Submit','expose'); ?>*</label></p>
						...
						<input type="hidden" id="sitesumbit" name="sitesumbit" value="true" />
